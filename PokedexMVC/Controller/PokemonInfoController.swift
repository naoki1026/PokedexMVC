...
//  PokedexMVC
//
//  Created by Naoki Arakawa on 2019/04/20.
...
class PokemonInfoController : UIViewController {
  ...
  let infoView: InfoView = {
    ...
    let view = InfoView()
    view.configureViewForInfoComponents()
    return view
  ...
  func configureViewComponents() {
    ...
    imageView.anchor(top: view.topAnchor, left: view.leftAnchor, bottom: nil, right: nil, paddingTop: 100, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 100, height: 100)
    ...
    infoView.anchor(top: infoLabel.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 150)
    
    view.addSubview(evolutionView)
    evolutionView.anchor(top: infoView.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 50)
